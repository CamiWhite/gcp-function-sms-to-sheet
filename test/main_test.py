...
class TestMain:
  ...
  def test_extract_with_decimals(self):
    message = 'BancoX le informa Pago por $10,000.52 a FABRICA DE JUGUETES SA desde cta *1111. 11/11/1111 11:11. Inquietudes al 0345109095/018000931987.'
    (reference, cost) =  main.extract_details(message)
    assert reference == 'FABRICA DE JUGUETES SA'
    assert cost == 10000